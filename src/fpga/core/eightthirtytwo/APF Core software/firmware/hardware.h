...
#define SPI_INTERFACE               0xFFFFFFD0
#define SPI_RST_USR                 0x1
#define SPI_RST_CPU                 0x2
#define SPI_CPU_HLT                 0x4

#define DATASLOT_RAM_BASEADDR       0xFFFF0000
#define DATASLOT_RAM_BUFFERSIZE     1024

#define MAIN_RAM_BASEADDR           0x00000000
#define MAIN_RAM_BUFFERSIZE         16384

#define APF_RAM_BASEADDR            0x80000000
#define APF_RAM_BUFFERSIZE          MAIN_RAM_BUFFERSIZE

#define TARGET_DATASLOT_ID          0xFFFFFF80
#define TARGET_DATASLOT_BRIDGEADDR  0xFFFFFF84
#define TARGET_DATASLOT_LENGTH      0xFFFFFF88
#define TARGET_DATASLOT_SLOTOFFSET  0xFFFFFF8C
#define TARGET_DATASLOT_CONTROL     0xFFFFFF90
#define RESET_OUT                   0xFFFFFFA4
#define DATASLOT_UPDATE_ID          0xFFFFFFB4
#define DATASLOT_UPDATE_SIZE        0xFFFFFFB8
#define DATASLOT_UPDATE_SIZE        0xFFFFFFB8

#define UARTBASE                    0xFFFFFFC0
#define TIMERBASE                   0xFFFFFFC8
#define SPI_INT                     0xFFFFFFD0
