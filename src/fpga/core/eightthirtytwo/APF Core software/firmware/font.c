...
-- adapted from the Minimig firmware by Dennis van Weeren,
-- Jakub Bednarski and others.
...
/* - defined in columns, not in rows */

unsigned char font[1+FONT_MAX-FONT_OFFSET][8] =
{
        ...
        {0x08,0x08,0x1C,0x1C,0x3E,0x3E,0x7F,0x7F},         // 128   [0x80] arrow left
        {0x7F,0x7F,0x3E,0x3E,0x1C,0x1C,0x08,0x08},         // 129   [0x81] arrow right
        {0x00,0x10,0x18,0x7c,0x7c,0x18,0x10,0x00},         // 130   [0x82] arrow up
        {0x00,0x10,0x30,0x7c,0x7c,0x30,0x10,0x00},         // 131   [0x83] arrow down
		{0x10,0x30,0x60,0x60,0x78,0x1e,0x06,0x00},         // 132   [0x84] checkmark
        {0x42,0x66,0x3c,0x18,0x3c,0x66,0x42,0x00},         // 133   [0x85] cross
        {0x78,0x38,0x6a,0xc2,0xc6,0x6c,0x38,0x00},         // 134   [0x86] cycle
        {0x60,0x00,0x00,0x60,0x00,0x00,0x60,0x00},         // 135   [0x87] ellipsis
};

/*
	........   Vertical: 0x10,0x30,0x60,0x60,0x78,0x1e,0x06,0x00
    .....XX.
    .....XX.
    ....XX..
    XX..XX..
	...
	........   Vertical: 0x42,0x66,0x3c,0x18,0x3c,0x66,0x42,0x00
	XX...XX.
    .XX.XX..
    ..XXX...
    ..XXX...
	...
	...XX...    Vertical 0x1e,0x1c,0x6a,0xc2,0xc6,0x6c,0x38,0x00
    X.XXXX..
    XXX..XX.
    XX....X.
    XXX .XX.
	...
	........    Vertical: 0x60,0x00,0x00,0x60,0x00,0x00,0x60,0x00
    ........
    ........
    ........
    ........
